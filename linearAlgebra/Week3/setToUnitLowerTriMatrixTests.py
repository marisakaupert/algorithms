...
class SetToUnitLowerTriMatrixUnblockedTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_set_to_unit_upper_tri_matrix_unb(self):
        ...
        self.assertEqual(
            [[1, 0, 0], [-1, 1, 0], [3, 2, 1]],
            practice.set_to_unit_lower_triangle_matrix(self.matrix_A))

    def test_zero_matrix_set_to_unit_upper_tri_unb(self):
        practice = Week3Functions()
        self.assertEqual(
            [[1, 0, 0], [0, 1, 0], [0, 0, 1]],
            practice.set_to_unit_lower_triangle_matrix(self.zero_matrix))

    def test_empty_matrix_set_to_unit_upper_tri_unb(self):
        practice = Week3Functions()
        self.assertEqual(
            [], practice.set_to_unit_lower_triangle_matrix([]))

    def test_illegal_matrix_set_to_unit_upper_tri_unb(self):
        practice = Week3Functions()
        self.assertEqual(
            'FAILED', practice.set_to_unit_lower_triangle_matrix(None))
