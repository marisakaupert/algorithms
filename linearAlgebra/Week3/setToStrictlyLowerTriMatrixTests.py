...
class SetToStrictlyLowerTriMatrixUnblockedTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_empty_matrix_set_to_strictly_upper_tri_unb(self):
        practice = Week3Functions()
        self.assertEqual(
            [], practice.set_to_strictly_lower_triangle_matrix([]))

    def test_illegal_matrix_set_to_strictly_upper_tri_unb(self):
        practice = Week3Functions()
        self.assertEqual(
            'FAILED', practice.set_to_strictly_lower_triangle_matrix(None))
